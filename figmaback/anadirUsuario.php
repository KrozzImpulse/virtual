...
if ($contraseña != $confirmar){
    ...
    <head>
            ...
            <script>
                    function r() { location.href="'.$frontEndSketis.'FigmaStore/registro.html"}
                    setTimeout ("r()", 3500);
                    </script>
            <style>
            body{
    ...
    <head>
            ...
            <link rel="shortcut icon" href="'.$frontEndSketis.'Assets/icons/logo_header.png" />
            <script>
                    function r() { location.href="'.$frontEndSketis.'FigmaStore/login.html"}
                    setTimeout ("r()", 2700);
                    </script>
            <style>
            body{
    ...
    <body>
        <tr>
            ...
            <td><p class="texto">Te has registrado de manera exitosa! Gracias por formar parte de FigmaStore.</br> seras redireccionado automaticamente....</p></td>
        </tr>
    </body>
</html>
        ';
