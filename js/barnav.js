var backendSketis="http://localhost/figmaback/";
  ...
  if (respuestaVerificarSesion.success === true) {
    ...
    if (respuestaVerificarSesion.tipo === 2) {
      ...
      document.getElementById("carro-opcion").innerHTML=`
                  <a href="carrito.html">
                  <img src="/FigmaStore/Assets/icons/baseline_shopping_cart_white_18dp.png" class="shopping-icon">
                  </a>`;                         
...
function cerrar_sesion(){
  ...
  peticionCerrarSesion.send();
    ...
    function verificarUbicacion() {
      if (window.location.pathname === "/FigmaStore/almacenistas.html"||
        window.location.pathname==="/registro-almacenista.html" || window.location.pathname==="/consultaLog.html") {
      ...
      }else if (window.location.pathname === "/FigmaStore/articulos.html"||
      ...
      else if (window.location.pathname === "/FigmaStore/cuenta.html") {
        if (tipoCuenta === 0||tipoCuenta === undefined) {
          window.location.href = '404.html';
        }
      }
      
      else if (window.location.pathname === "/FigmaStore/inicio.html"){
        if (tipoCuenta === 3)
        {
      ...
      else if (window.location.pathname === "/FigmaStore/Figmas.html"){
        if (tipoCuenta === 3)
        {
          window.location.href = '404.html';
        }
      ...
      else if (window.location.pathname === "/FigmaStore/Gunplas.html"){
        if (tipoCuenta === 3)
        {
          window.location.href = '404.html';
        }
      ...
      else if (window.location.pathname === "/FigmaStore/plushies.html"){
        if (tipoCuenta === 3)
        {
          window.location.href = '404.html';
        }
